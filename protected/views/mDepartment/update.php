...
<div class="full_w">
	<div class="h_title">Management-Edit-Department</div>
	<?php 
	...
	?>
		...
		<div class="element">
			...
			</label> <?php echo $form->textField(MDepartment::model(), 'department_code', array('id'=>'department_code', 'size' => 20, 'maxlength' => 255,'value'=>$model->department_code)); ?>
		...
		<div class="element">
			<label for="name">App ID <span class="red">(required)</span>
				...
				<select id="app_id" name="MDepartment[app_id]">
					...
					<option value="<?php echo $appStore->id?>" <?php echo $appStore->id == $model->app_id ? 'selected="selected"' : ''?>><?php echo $appStore->name?></option>
					<?php }?>
				</select>
		...
		<div class="element">
			...
			</label> <?php echo $form->textField(MDepartment::model(), 'name', array('id'=>'name','size' => 20, 'maxlength' => 255,'value'=>$model->name)); ?>
			<div id="txtname"></div>
		</div>
		<div class="element">
			<label for="name">Description </label> <?php echo $form->textArea(MDepartment::model(), 'description', array('value'=>$model->description)); ?>
		</div>
		<div class="entry">
