...
<div class="full_w">
	<div class="h_title">Management-Create-User Role</div>
	<?php 
	...
	?>
		...
		<div class="element">
			...
			</label> <?php echo $form->textField(UsersRole::model(), 'name', array('id'=>'name', 'size' => 20, 'maxlength' => 255)); ?>
			<div id="txtname"></div>
		</div>
		<div class="element">
		...
		<div class="element">
			...
			</label> <?php echo $form->textArea(UsersRole::model(), 'description', array()); ?>
		</div>
