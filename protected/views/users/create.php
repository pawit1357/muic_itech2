...
<div class="full_w">
	<div class="h_title">Management-Create-User</div>
	<?php 
	...
	<div class="element">
		...
		<?php echo $form->textField(Users::model(), 'username', array('id'=>'username', 'size' => 50, 'maxlength' => 255)); ?>
	...
	<div class="element">
		<label for="name">Role <span class="red">(required)</span>
		</label>
		<?php 
		...
		<select id="role_id" name="Users[role_id]">
			...
			<option value="<?php echo $mRole->id?>"><?php echo $mRole->name?></option>
			<?php }?>
		</select>
	...
	<div class="element">
		...
		<?php echo $form->textField(Users::model(), 'email', array('id'=>'email', 'size' => 50, 'maxlength' => 255)); ?>
		<div id="txtemail"></div>
	</div>
	<div class="element">
