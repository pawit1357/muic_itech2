...
<div class="full_w">
	<div class="h_title">Management-Edit-Content</div>
	<?php 
	...
	<div class="element">
		...
		<?php echo $form->textArea(AppContent::model(), 'topic', array('size' => 50, 'maxlength' => 255, 'value'=>$model->topic)); ?>
	</div>

	<div class="element">
		<label for="name">Description <span class="red">(required)</span>
		</label>
		<?php echo $form->textArea(AppContent::model(), 'description', array('id'=>'description' ,'size' => 50, 'maxlength' => 255,'class' => 'ckeditor', 'value'=>$model->description)); ?>
		...
		<?php echo $form->textField(AppContent::model(), 'image_src1', array('id'=>'image_src1', 'size' => 100, 'maxlength' => 255, 'value'=>$model->image_src1)); ?>
	</div>
	...
	<div class="element">
		...
		<?//php echo $form->hiddenField(AppContent::model(), 'image_src1', array('size' => 50, 'maxlength' => 255, 'value'=>$model->image_src1)); ?>
	...
	<div class="element">
		...
		<?//php echo $form->hiddenField(AppContent::model(), 'image_src2', array('size' => 50, 'maxlength' => 255, 'value'=>$model->image_src2)); ?>
		<?/* $this->widget('ext.EAjaxUpload.EAjaxUpload',
				array(
			        'id'=>'image_src2',
			        'config'=>array(
