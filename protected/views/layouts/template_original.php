			...
			<div id="top">
				<div class="left">
					...
					<p>
						...
						<strong> </strong> [ <a
							href="/itechservice/index.php/Dashboard/Logout">logout</a> ]
					</p>
				...
				<div class="right">
					<div class="align-right">
						<p>
							<img src="/itechservice/images/muiclogo.png" height="40px;"
		...
		<div id="content">
			<div id="sidebar">
					...
					<ul id="home">
						...
						<li class="b1"><a class="icon add_page"
							href="<?php echo Yii::app()->createUrl('Question')?>">Manage
								...
								{
									?> <img src="/itechservice/images/i_error.png" /> <?php
								}
								?>
						</li>
						<li class="b1"><a class="icon add_page"
				...
				<div class="box">
					...
					<ul>
						<li class="b2"><a class="icon config"
							href="<?php echo Yii::app()->createUrl('MDepartment')?>">Department</a>
						</li>
						<li class="b2"><a class="icon config"
							href="<?php echo Yii::app()->createUrl('UsersRole')?>">User Role</a>
						</li>
						<li class="b2"><a class="icon config"
							href="<?php echo Yii::app()->createUrl('MStatus')?>">Status</a>
						</li>
						<li class="b2"><a class="icon config"
							href="<?php echo Yii::app()->createUrl('MStatusGroup')?>">Status
								Group</a>
						</li>
