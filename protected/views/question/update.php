...
<div class="full_w">
	<div class="h_title">Management-Edit-Question</div>
	<?php 
	...
	<div class="element">
		...
		<?php echo $form->textArea(Question::model(), 'question', array('id'=>'question','size' => 20, 'maxlength' => 255,'class' => 'ckeditor', 'value'=>$model->question)); ?>
