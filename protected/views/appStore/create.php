...
function validateForm(){
	...
	if(txtUrl==""){
		$("#url").focus();
		$('#txtUrlValidate').html('<b style="color:red">*URL invalid</b>');
			isResult = false;
			return false;
		}else{
				$('#txtUrl').html('');
...
<div
	class="full_w">
	<div class="h_title">Management-Create-Store</div>
	<?php 
	...
	<div class="element">
		...
		<?php echo $form->textField(AppStore::model(), 'name', array('id'=>'name', 'size' => 50, 'maxlength' => 255)); ?>
	...
	<div class="element">
		...
		<?php echo $form->textField(AppStore::model(), 'bundle', array('id'=>'bundle', 'size' => 50, 'maxlength' => 255)); ?>
		<div id="txtBundleValidate"></div>
	</div>
	<div class="element">
		<label for="name">URL <span class="red">(required)</span>
		</label>
		<?php echo $form->textField(AppStore::model(), 'url', array('id'=>'url', 'size' => 50, 'maxlength' => 255)); ?>
		<div id="txtUrlValidate"></div>
	</div>
		<div class="element">
		<label for="name">Questionnaire Url <span class="red">(required)</span>
		</label>
		<?php echo $form->textField(AppStore::model(), 'questionnaire_url', array('id'=>'questionnaire_url', 'size' => 50, 'maxlength' => 255)); ?>
