...
<div class="full_w">
	<div class="h_title">Management-Edit-Question Answer</div>
	<?php 
	...
	<div class="element">
		...
		<select id="question_id" name="QuestionAnswer[question_id]">
			...
			<?php echo $question->id == $model->question_id ? 'selected="selected"' : ''?>><?php echo $question->question?></option>
			<?php }?>
		</select>
	...
	<div class="element">
		...
		<?php echo $form->textArea(QuestionAnswer::model(), 'answer', array('id'=>'answer','size' => 20, 'maxlength' => 255, 'value'=>$model->answer,'class' => 'ckeditor')); ?>
