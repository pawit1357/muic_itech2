...
<div class="full_w">
	<div class="h_title">Management-Create-Gallery</div>
	...
	<div class="element">
		...
		<select id="menu_id" name="AppGallery[menu_id]">
			...
			<option value="<?php echo $appMenu->id?>" selected><?php echo $appMenu->menu_item?></option>
			<?php }?>
		</select>
	...
	<div class="element">
		...
		<?php echo $form->hiddenField(AppGallery::model(), 'image_src1', array('size' => 50, 'maxlength' => 255)); ?>
	...
	<div class="element">
		...
		<?php echo $form->hiddenField(AppGallery::model(), 'image_src2', array('size' => 50, 'maxlength' => 255)); ?>
